...
#                 num_pos_classes += 1
                result[slide_id] = (args.class_name[1],bag_prediction[1],sp_label_dict[int(bag_info['seq_id'])])
                print(slide_id + ' is detected as: ' + args.class_name[1])
            else:
                result[slide_id] = (args.class_name[0],bag_prediction[1],sp_label_dict[int(bag_info['seq_id'])])
