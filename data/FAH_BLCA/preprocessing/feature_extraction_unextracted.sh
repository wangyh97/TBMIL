# nohup python feature_extraction_unextracted --scale 10 --extractor pretrained_resnet18 &> fe_10_pretrained_resnet18.out &
# nohup python feature_extraction_unextracted.py --scale 10 --extractor pretrained_resnet50 &> fe_10_pretrained_resnet50.out &
