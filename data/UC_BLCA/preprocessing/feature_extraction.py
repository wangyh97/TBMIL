...
#     model = model.cuda()
    ...
    patches = list(Path(f'/GPUFS/sysu_jhluo_1/wangyh/data/FAH_BLCA/CN_patches/size512/{args.scale}X').rglob('*.h5'))
                ...
                for patch in tqdm(patches):
                    ...
                    try:
                        with h5py.File(patch,'r') as f:
                            ...
                            slide_features[slide_id] = {'seq_id':seq_id,'features': feature_list,'coords':coords}
